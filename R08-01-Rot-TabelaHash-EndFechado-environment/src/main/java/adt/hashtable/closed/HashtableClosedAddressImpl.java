...
public class HashtableClosedAddressImpl<T> extends AbstractHashtableClosedAddress<T> {
   ...
   public void insert(T element) {
	   ...
	   if (!((LinkedList<T>) this.table[((HashFunctionClosedAddress<T>) this.hashFunction).hash(element)]).contains(element)) {
   ...
   public T search(T element) {
      T saida = null;
      if (((LinkedList<T>) this.table[((HashFunctionClosedAddress<T>) this.hashFunction).hash(element)]) != null) {
    	  if (((LinkedList<T>) this.table[((HashFunctionClosedAddress<T>) this.hashFunction).hash(element)]).contains(element)) {
    		  saida = element;
    	  }
      }
   ...
   public int indexOf(T element) {
       ...
       if (((LinkedList<T>) this.table[((HashFunctionClosedAddress<T>) this.hashFunction).hash(element)]) != null) {
    	   if (((LinkedList<T>) this.table[((HashFunctionClosedAddress<T>) this.hashFunction).hash(element)]).contains(element)) {
    		   res = ((HashFunctionClosedAddress<T>) this.hashFunction).hash(element);
    	   }
       }
       return res;
   }
